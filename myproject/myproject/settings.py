...
SECRET_KEY = 'django-insecure-v9it8-76%h%e&)pm&4(uk4pw-%waauqtym^c77vmn12*rswh7+'
...
SOCIALACCOUNT_PROVIDERS = {
        "google": {
        "APP": {
            "client_id": env("GOOGLE_CLIENT_ID"), # claves google
    ...
    "github": {
        "APP": {
            "client_id": env("GITHUB_CLIENT_ID"),   # claves github
